...
namespace SimpleActor
{
    ...
    /// </remarks>
    internal class SimpleActor : StatefulActor<SimpleActor.ActorState>, ISimpleActor
    {
        /// <summary>
        ...
        [Readonly]
        Task<int> ISimpleActor.GetCountAsync()
        {
        ...
        Task ISimpleActor.SetCountAsync(int count)
        {
